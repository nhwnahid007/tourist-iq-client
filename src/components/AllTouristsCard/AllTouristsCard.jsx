...
const AllTouristsCard = ({ allTourist }) => {
  const { photo, spot, location, country, time, price,number,season } = allTourist;
  return (
    <div>
      <div className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
        <div className="rounded overflow-hidden flex flex-col max-w-xl mx-auto">
          ...
          <div className="relative rounded-lg -mt-24 px-10 pt-2 pb-16 bg-white m-10">
            <a
              href="#"
            ...
            <button className="relative inline-flex items-center justify-center p-0.5 mt-5 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-pink-500 to-orange-400 group-hover:from-pink-500 group-hover:to-orange-400 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800">
