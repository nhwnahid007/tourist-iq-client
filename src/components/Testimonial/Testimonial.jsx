      ...
      <section className="my-8 dark:bg-gray-100 dark:text-gray-800">
        <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
          ...
          <p className="px-6 py-2 text-2xl font-semibold text-center sm:font-bold sm:text-3xl md:text-4xl lg:max-w-2xl xl:max-w-4xl dark:text-gray-700">
            &quot;At TravelIQ, we&apos;re passionate about making your travel
            experiences extraordinary. As a leading travel management platform,
            we specialize in providing personalized solutions for all your
            travel needs. Whether you&apos;re planning a relaxing getaway, an
            adventurous expedition, or a business trip, TravelIQ has you
            covered. Our user-friendly interface allows you to explore a vast
            array of destinations, discover hidden gems, and book accommodations
            seamlessly. Let
            us turn your travel dreams into unforgettable realities.&quot;
          </p>
